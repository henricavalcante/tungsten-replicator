...
CURSOR C1 IS SELECT CHANGE_TABLE_NAME FROM CHANGE_TABLES where CHANGE_SET_NAME=v_change_set_name;
...
BEGIN
  ...
  SELECT SET_NAME into v_existing_change_set from CHANGE_SETS where SET_NAME=v_change_set_name;

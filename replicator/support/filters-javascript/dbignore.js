 ...
 *
 * Allows one to select a specific schema to replicate while ignoring others
 * on the slave. This way one can configure multiple slaves to replicate
 * different schemas or just ignore the ones don't needed. Works on both
 * statement and row replication.
 *
 ...
 * replicator.filter.dbignore.script=../support/filters-javascript/dbignore.js
